...
```{r}
bikes_data_tsibble <- as_tsibble(nyc_bikes_df, key = c(bike_id, start_station, end_station, gender, client_age, year, quarter, month, day, trip_duration), index = start_time)
bikes_data_tsibble
```
